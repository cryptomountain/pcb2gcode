...
public:
    ...
    void export_ngc(const string of_name, shared_ptr<Driller> target, bool onedrill, bool tinyg, bool nog81);
    void export_ngc(const string of_name, shared_ptr<Cutter> target, bool tinyg);
